...
public class Baron extends Card {
    ...
    public void appliquerEffet(Player joueurActif) {
        CoreGame.view.afficherMessage("Le Baron a été joué. Il compare les cartes de deux joueurs, le plus faible quitte la manche");

        Player choix = CoreGame.demanderCible(joueurActif, this);

        // Gérer le cas où aucune cible n'est disponible
        if (choix == null) {
            CoreGame.view.afficherMessage("Aucune cible disponible pour le Baron. L'effet est annulé.");
            return;
        }
